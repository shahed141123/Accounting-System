...
class TableExportController extends Controller
{
    ...
    {
        // retreive all records from db
        $data = ExpenseSubCategory::with('expenseCategory')->latest()->get()->toArray();
        // share data to view
        view()->share('categories', $data);
    ...
    {
        // retreive all records from db
        $data = Expense::with('expSubCategory.expenseCategory', 'expTransaction.cashbookAccount')->latest()->get()->toArray();
        // share data to view
