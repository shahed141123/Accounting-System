...
class HomeController extends Controller
{
    public function home()
    {
        ...
        $data = [
            ...
            'latest_products'  => Product::select('slug','meta_title','thumnail','name','box_discount_price','box_price')->with('multiImages')->latest('id')->where('status','published')->limit(10)->get(),
            'deal_products'    => Product::select('slug','meta_title','thumnail','name','box_discount_price','box_price')->with('multiImages')->whereNotNull('box_discount_price')->where('status','published')->latest('id')->limit(10)->get(),
        ];
