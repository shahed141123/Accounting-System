                                ...
                                <div class="dashboard-tab">
                                    <div class="title-box3">
                                        ...
                                        <p>
                                            ...
                                            effortlessly. Here, you can view your order history, update your details,
                                            and place quick orders. Additionally, you can subscribe to our daily stock
                                            feed, check stock availability, download product images and data, view your
                                    ...
                                    <div class="row g-0 option-wrap">
                                        <div class="col-sm-6 col-xl-4">
                                            <a href="user-order-history.html" data-class="orders" class="tab-box">
                                                <img src="{{ asset('frontend/img/icon/1.svg') }}" alt="shopping bag">
                                                <h5>Order History</h5>
                                                <p>Search and View Your Online Order History with Ease.</p>
                                            </a>
                                        </div>
                                        <div class="col-sm-6 col-xl-4">
                                            <a href="user-account-details.html" data-class="wishlist" class="tab-box">
                                        ...
                                        <div class="col-sm-6 col-xl-4">
                                            <a href="user-quickorder.html" data-class="savedAddress" class="tab-box">
                                            ...
                                            <div class="order-info">
                                                <div class="product-details" data-productdetail="product-detail">
                                                    ...
                                                    <div class="product-content">
                                                        <h5>Women’s long sleeve Jacket</h5>
                                                        <p class="truncate-3">
                                                            Tunic knitted stretch leather spaghetti straps triangle top
                                                            patterned panelled purple blush. Versatile sporty slogans
                                            ...
                                            <div class="order-info">
                                                <div class="product-details" data-productdetail="product-detail">
                                                    ...
                                                    <div class="product-content">
                                                        <h5>Women’s long sleeve Jacket</h5>
                                                        <p class="truncate-3">
                                                            Pop top sporty stripe trims mesh inserts denim turtle neck
                                                            casual white cotton button silver.Back print tattoo graphics
                                        ...
                                        <div class="col-12">
                                            <div class="product-details">
                                                ...
                                                <div class="product-content">
                                                    <h5>Women’s long sleeve Jacket</h5>
                                                    <p class="truncate-3">
                                                        Versatile sporty slogans short sleeve quirky laid back orange
                                                        lux hoodies vests pins badges. Versatile sporty slogans short
                                            ...
                                            <div class="row gy-3 gy-sm-0 g-3 g-md-4">
                                                <div class="col-sm-6">
                                                    <div class="order-data general-details">
                                                        ...
                                                        <!-- Payment Method End -->
                                                        <button class="btn-solid mb-line btn-sm mt-4">Get Invoice <i
                                                                class="arrow"></i></button>
                                                    </div>
                                                </div>
                                                <div class="col-sm-6">
                                    ...
                                    <div class="row g-3 g-md-4">
                                        ...
                                        <div class="col-md-6 col-lg-12 col-xl-6">
                                            <div class="address-box">
                                                ...
                                                <div class="address-detail">
                                                    <p class="content-color font-default">198 Terry Lane Orlando, FL
                                                        32809</p>
                                ...
                                <div class="payment-tab">
                                    <div
                                        ...
                                        <div>
                                            ...
                                            <p>here is your saved card, from here you can easily add or modify your card
                                            </p>
                                        </div>
                                        <button class="btn btn-outline btn-sm white-space-no" data-bs-toggle="modal"
                                            ...
                                            <div class="col-sm-6 col-xl-4">
                                                <div class="payment-card bg-theme-blue border-color-blue">
                                                    ...
                                                    <div class="btn-box">
                                                        ...
                                                        <span data-bs-toggle="modal" data-bs-target="#conformation">
                                                            <svg xmlns="http://www.w3.org/2000/svg" width="24"
                                                                height="24" viewBox="0 0 24 24" fill="none"
                                                                stroke="currentColor" stroke-width="2"
                                                                stroke-linecap="round" stroke-linejoin="round"
                                ...
                                <div class="privacy-tab">
                                    <div class="privacy box">
                                        ...
                                        <div class="setting-option mt-3">
                                            <div class="content-box">
                                                <h6 class="font-roboto">Who has save this profile only that people see
                                                    my profile</h6>
                                                <p class="font-roboto">all peoples will not be able to see my profile.
                                                </p>
                                            </div>
                                    ...
                                    <div class="account-box">
                                        ...
                                        <div class="setting-option">
                                            <div class="content-box">
                                                ...
                                                <p class="font-roboto">Once your account is deleted, you will be logged
