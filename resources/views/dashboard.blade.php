                  ...
                  <div class="col-lg-4 col-xl-3 sticky">
                     ...
                     <div class="side-bar">
                        ...
                        <div class="profile-box">
                           <div class="img-box">
                              <img class="img-fluid" src="img/avatar/avatar.jpg" alt="user">
                              <div class="edit-btn">
                        ...
                        <ul class="nav nav-tabs nav-tabs2" id="myTab" role="tablist">
                          ...
                          <li class="nav-item" role="presentation">
                             <a href="user-order-history.html" class="nav-link">
                               My Order History
                                <span>
                                   <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-chevron-right">
                                      <polyline points="9 18 15 12 9 6"></polyline>
                          ...
                          <li class="nav-item" role="presentation">
                               <a href="user-account-details.html" class="nav-link">
                               My Account Details
                               <span>
                                   <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-chevron-right">
                                       <polyline points="9 18 15 12 9 6"></polyline>
                           ...
                           <li class="nav-item" role="presentation">
                               <a href="user-quickorder.html" class="nav-link">
                                  Quick Order
                               <span>
                                   <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-chevron-right">
                                       <polyline points="9 18 15 12 9 6"></polyline>
                           ...
                           <li class="nav-item" role="presentation">
                               <a href="user-stock-history.html" class="nav-link">
                                  Stock Availability
                               <span>
                                   <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-chevron-right">
                                       <polyline points="9 18 15 12 9 6"></polyline>
                        ...
                        <div class="tab-pane show active" id="dashboard" role="tabpanel" aria-labelledby="dashboard-tab">
                           <div class="dashboard-tab">
                              <div class="title-box3">
                                 ...
                                 <p>
                                   Welcome to your account page, where you can manage your Trade Account effortlessly. Here, you can view your order history, update your details, and place quick orders. Additionally, you can subscribe to our daily stock feed, check stock availability, download product images and data, view your saved shopping lists, and download a PDF product catalog.
                                 </p>
                              </div>
                              <div class="row g-0 option-wrap">
                                 <div class="col-sm-6 col-xl-4">
                                    <a href="user-order-history.html" data-class="orders" class="tab-box">
                                       <img src="img/icon/1.svg" alt="shopping bag">
                                       <h5>Order History</h5>
                                 ...
                                 <div class="col-sm-6 col-xl-4">
                                    <a href="user-account-details.html" data-class="wishlist" class="tab-box">
                                       <img src="img/icon/2.svg" alt="wishlist">
                                 ...
                                 <div class="col-sm-6 col-xl-4">
                                    <a href="user-quickorder.html" data-class="savedAddress" class="tab-box">
                                       <img src="img/icon/3.svg" alt="address">
                                       <h5>Quick order</h5>
                                 ...
                                 <div class="col-sm-6 col-xl-4">
                                    <a href="user-stock-history.html" data-class="payment" class="tab-box">
                                       <img src="img/icon/4.svg" alt="payment">
                                 ...
                                 <div class="col-sm-6 col-xl-4">
                                    <a href="javascript:void(0)" data-class="profile" class="tab-box">
                                       <img src="img/icon/5.svg" alt="profile">
                                 ...
                                 <div class="col-sm-6 col-xl-4">
                                    <a href="javascript:void(0)" data-class="security" class="tab-box">
                                       <img src="img/icon/6.svg" alt="security">
                                    ...
                                    <div class="address-box checked">
                                       <div class="radio-box">
                                          ...
                                          <div class="option-wrap">
                                             <span class="edit" data-bs-toggle="modal" data-bs-target="#edditAddress">
                                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-edit">
                                                   <path d="M11 4H4a2 2 0 0 0-2 2v14a2 2 0 0 0 2 2h14a2 2 0 0 0 2-2v-7"></path>
                                                   <path d="M18.5 2.5a2.121 2.121 0 0 1 3 3L12 15l-4 1 1-4 9.5-9.5z"></path>
                                                </svg>
