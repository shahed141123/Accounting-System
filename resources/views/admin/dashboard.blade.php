                            ...
                            <ul class="nav nav-pills nav-pills-custom mb-3">
                                <li class="nav-item mb-3 me-3 me-lg-6">
                                    <a class="nav-link d-flex justify-content-between flex-column flex-center overflow-hidden active w-80px h-85px py-4"
                                        ...
                                        <div class="nav-icon">
                                            <img alt=""
                                                src="https://preview.keenthemes.com/metronic8/demo1/assets/media/svg/products-categories/t-shirt.svg"
                                                class="" />
                                        </div>
                                ...
                                <li class="nav-item mb-3 me-3 me-lg-6">
                                    <a class="nav-link d-flex justify-content-between flex-column flex-center overflow-hidden w-80px h-85px py-4"
                                        ...
                                        <div class="nav-icon">
                                            <img alt=""
                                                src="https://preview.keenthemes.com/metronic8/demo1/assets/media/svg/products-categories/gaming.svg"
                                                class="" />
                                        </div>
                                ...
                                <li class="nav-item mb-3 me-3 me-lg-6">
                                    <a class="nav-link d-flex justify-content-between flex-column flex-center overflow-hidden w-80px h-85px py-4"
                                        ...
                                        <div class="nav-icon">
                                            <img alt=""
                                                src="https://preview.keenthemes.com/metronic8/demo1/assets/media/svg/products-categories/watch.svg"
                                                class="" />
                                        </div>
                                ...
                                <li class="nav-item mb-3 me-3 me-lg-6">
                                    <a class="nav-link d-flex justify-content-between flex-column flex-center overflow-hidden w-80px h-85px py-4"
                                        ...
                                        <div class="nav-icon">
                                            <img alt=""
                                                src="https://preview.keenthemes.com/metronic8/demo1/assets/media/svg/products-categories/gloves.svg"
                                                class="nav-icon" />
                                        </div>
                                ...
                                <li class="nav-item mb-3">
                                    <a class="nav-link d-flex justify-content-between flex-column flex-center overflow-hidden w-80px h-85px py-4"
                                        ...
                                        <div class="nav-icon">
                                            <img alt=""
                                                src="https://preview.keenthemes.com/metronic8/demo1/assets/media/svg/products-categories/shoes.svg"
                                                class="nav-icon" />
                                        </div>
                                ...
                                <div class="tab-pane fade show active" id="kt_stats_widget_2_tab_1">
                                    <div class="table-responsive">
                                        <table class="table table-row-dashed align-middle gs-0 gy-4 my-0">
                                            <thead>
                                                <tr class="fs-7 fw-bold text-gray-500 border-bottom-0 text-center">
                                                    <th class="ps-0 w-50px ps-3">ITEM</th>
                                                    <th class="min-w-125px"></th>
                                                    <th class="text-end min-w-100px">QTY</th>
                                                    <th class="pe-0 text-end min-w-100px">PRICE</th>
                                                    <th class="pe-0 text-end min-w-100px pe-3">TOTAL PRICE</th>
                                                </tr>
                                            </thead>
                                            ...
                                            <tbody>
                                                <tr>
                                                    <td>
                                                        <img src="https://preview.keenthemes.com/metronic8/demo1/assets/media/stock/ecommerce/210.png"
                                                ...
                                                <tr>
                                                    <td>
                                                        <img src="https://preview.keenthemes.com/metronic8/demo1/assets/media/stock/ecommerce/215.png"
                                                            class="w-50px ms-n1" alt="" />
                                                    </td>
                                                    <td class="ps-0">
                                                        <a href="https://preview.keenthemes.com/metronic8/demo1/apps/ecommerce/catalog/edit-product.html"
                                                ...
                                                <tr>
                                                    <td>
                                                        <img src="https://preview.keenthemes.com/metronic8/demo1/assets/media/stock/ecommerce/209.png"
                                                            class="w-50px ms-n1" alt="" />
                                                    </td>
                                                    <td class="ps-0">
                                                        <a href="https://preview.keenthemes.com/metronic8/demo1/apps/ecommerce/catalog/edit-product.html"
                                    ...
                                    <div class="table-responsive">
                                        <table class="table table-row-dashed align-middle gs-0 gy-4 my-0">
                                            ...
                                            <tbody>
                                                <tr>
                                                    <td>
                                                        <img src="https://preview.keenthemes.com/metronic8/demo1/assets/media/stock/ecommerce/197.png"
                                                            class="w-50px ms-n1" alt="" />
                                                    </td>
                                                    <td class="ps-0">
                                                        <a href="https://preview.keenthemes.com/metronic8/demo1/apps/ecommerce/catalog/edit-product.html"
                                                ...
                                                <tr>
                                                    <td>
                                                        <img src="https://preview.keenthemes.com/metronic8/demo1/assets/media/stock/ecommerce/178.png"
                                                            class="w-50px ms-n1" alt="" />
                                                    </td>
                                                    <td class="ps-0">
                                                        <a href="https://preview.keenthemes.com/metronic8/demo1/apps/ecommerce/catalog/edit-product.html"
                                                ...
                                                <tr>
                                                    <td>
                                                        <img src="https://preview.keenthemes.com/metronic8/demo1/assets/media/stock/ecommerce/22.png"
                                                            class="w-50px ms-n1" alt="" />
                                                    </td>
                                                    <td class="ps-0">
                                                        <a href="https://preview.keenthemes.com/metronic8/demo1/apps/ecommerce/catalog/edit-product.html"
                                    ...
                                    <div class="table-responsive">
                                        <table class="table table-row-dashed align-middle gs-0 gy-4 my-0">
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    <td>
                                                        <img src="https://preview.keenthemes.com/metronic8/demo1/assets/media/stock/ecommerce/24.png"
                                                            class="w-50px ms-n1" alt="" />
                                                    </td>
                                                    <td class="ps-0">
                                                        <a href="https://preview.keenthemes.com/metronic8/demo1/apps/ecommerce/catalog/edit-product.html"
                                                ...
                                                <tr>
                                                    <td>
                                                        <img src="https://preview.keenthemes.com/metronic8/demo1/assets/media/stock/ecommerce/71.png"
                                                            class="w-50px ms-n1" alt="" />
                                                    </td>
                                                    <td class="ps-0">
                                                        <a href="https://preview.keenthemes.com/metronic8/demo1/apps/ecommerce/catalog/edit-product.html"
                                    ...
                                    <div class="table-responsive">
                                        <table class="table table-row-dashed align-middle gs-0 gy-4 my-0">
                                            ...
                                            <tbody>
                                                <tr>
                                                    <td>
                                                        <img src="https://preview.keenthemes.com/metronic8/demo1/assets/media/stock/ecommerce/41.png"
                                                            class="w-50px ms-n1" alt="" />
                                                    </td>
                                                    <td class="ps-0">
                                                        <a href="https://preview.keenthemes.com/metronic8/demo1/apps/ecommerce/catalog/edit-product.html"
                                                ...
                                                <tr>
                                                    <td>
                                                        <img src="https://preview.keenthemes.com/metronic8/demo1/assets/media/stock/ecommerce/63.png"
                                                            class="w-50px ms-n1" alt="" />
                                                    </td>
                                                    <td class="ps-0">
                                                        <a href="https://preview.keenthemes.com/metronic8/demo1/apps/ecommerce/catalog/edit-product.html"
                                                ...
                                                <tr>
                                                    <td>
                                                        <img src="https://preview.keenthemes.com/metronic8/demo1/assets/media/stock/ecommerce/59.png"
                                                            class="w-50px ms-n1" alt="" />
                                                    </td>
                                                    <td class="ps-0">
                                                        <a href="https://preview.keenthemes.com/metronic8/demo1/apps/ecommerce/catalog/edit-product.html"
                                    ...
                                    <div class="table-responsive">
                                        <table class="table table-row-dashed align-middle gs-0 gy-4 my-0">
                                            ...
                                            <tbody>
                                                <tr>
                                                    <td>
                                                        <img src="https://preview.keenthemes.com/metronic8/demo1/assets/media/stock/ecommerce/10.png"
                                                            class="w-50px ms-n1" alt="" />
                                                    </td>
                                                    <td class="ps-0">
                                                        <a href="https://preview.keenthemes.com/metronic8/demo1/apps/ecommerce/catalog/edit-product.html"
                                                ...
                                                <tr>
                                                    <td>
                                                        <img src="https://preview.keenthemes.com/metronic8/demo1/assets/media/stock/ecommerce/96.png"
                                                            class="w-50px ms-n1" alt="" />
                                                    </td>
                                                    <td class="ps-0">
                                                        <a href="https://preview.keenthemes.com/metronic8/demo1/apps/ecommerce/catalog/edit-product.html"
                                                ...
                                                <tr>
                                                    <td>
                                                        <img src="https://preview.keenthemes.com/metronic8/demo1/assets/media/stock/ecommerce/13.png"
                                                            class="w-50px ms-n1" alt="" />
                                                    </td>
                                                    <td class="ps-0">
                                                        <a href="https://preview.keenthemes.com/metronic8/demo1/apps/ecommerce/catalog/edit-product.html"
                            ...
                            <div class="row align-items-center h-100">
                                <div class="col-7 ps-xl-13">
                                    ...
                                    <span class="fw-semibold text-white fs-6 mb-8 d-block opacity-75">
                                        Flat cartoony and illustrations with vivid unblended purple hair
                                        lady
                                    </span>
                                ...
                                <div class="col-5 pt-10">
                                    <div class="bgi-no-repeat bgi-size-contain bgi-position-x-end h-225px"
                                        style="background-image:url('https://preview.keenthemes.com/metronic8/demo1/assets/media/svg/illustrations/easy/5.svg">
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="card-body d-flex flex-column flex-center">
                            <div class="mb-2">
                                ...
                                <div class="py-10 text-center">
                                    ...
                                    <img src="https://preview.keenthemes.com/metronic8/demo1/assets/media/svg/illustrations/easy/2-dark.svg"
                            ...
                            <div class="text-center mb-1">
                                <a class="btn btn-sm btn-primary me-2"
                                    href="https://preview.keenthemes.com/metronic8/demo1/apps/ecommerce/sales/listing.html">
                                    View App
                                </a>

                                <a class="btn btn-sm btn-light"
                                    href="https://preview.keenthemes.com/metronic8/demo1/apps/ecommerce/catalog/add-product.html">
                                    New Product
                                </a>
                            </div>
                        </div>
                            ...
                            <table class="table align-middle table-row-dashed fs-6 gy-3" id="kt_table_widget_4_table">
                                <thead>
                                    <tr class="text-start text-gray-500 fw-bold fs-7 text-uppercase gs-0">
                                        <th class="min-w-100px ps-3">Order ID</th>
                                        <th class="text-end min-w-100px">Created</th>
                                        <th class="text-end min-w-125px">Customer</th>
                                        <th class="text-end min-w-100px">Total</th>
                                        <th class="text-end min-w-100px">Profit</th>
                                        <th class="text-end min-w-50px pe-3">Status</th>
                                        ...
                                        <td colspan="2">
                                            <div class="d-flex align-items-center gap-3">
                                                <a href="#"
                                                    ...
                                                    <img src=""
                                                        data-kt-src-path="https://preview.keenthemes.com/metronic8/demo1/assets/media/stock/ecommerce/"
                ...
                <div class="col-xl-4">
                    <div class="card card-flush h-xl-100">
                        <div class="card-header pt-7">
                            ...
                            <div class="card-toolbar">
                                <a href="https://preview.keenthemes.com/metronic8/demo1/apps/ecommerce/sales/details.html"
                        ...
                        <div class="card-body">
                            <div class="hover-scroll-overlay-y pe-6 me-n6" style="height: 415px">
                                ...
                                <div class="border border-dashed border-gray-300 rounded px-7 py-3 mb-6">
                                    <div class="d-flex flex-stack mb-3">
                                        <div class="me-3">
                                            <img src="https://preview.keenthemes.com/metronic8/demo1/assets/media/stock/ecommerce/214.png"
                                                class="w-50px ms-n1 me-1" alt="" />
                                ...
                                <div class="border border-dashed border-gray-300 rounded px-7 py-3 mb-6">
                                    <div class="d-flex flex-stack mb-3">
                                        <div class="me-3">
                                            <img src="https://preview.keenthemes.com/metronic8/demo1/assets/media/stock/ecommerce/211.png"
                                                class="w-50px ms-n1 me-1" alt="" />
                                        ...
                                        <div class="m-0">
                                            ...
                                            <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-800 menu-state-bg-light-primary fw-semibold w-200px"
                                                ...
                                                <div class="menu-item px-3" data-kt-menu-trigger="hover"
                                                    ...
                                                    <div class="menu-sub menu-sub-dropdown w-175px py-4">
                                                        <div class="menu-item px-3">
                                                            <a href="#" class="menu-link px-3"> Admin Group
                                                            </a>
                                                        </div>

                                                        <div class="menu-item px-3">
                                                            <a href="#" class="menu-link px-3"> Staff Group
                                                            </a>
                                                        </div>
                                ...
                                <div class="border border-dashed border-gray-300 rounded px-7 py-3">
                                    <div class="d-flex flex-stack mb-3">
                                        <div class="me-3">
                                            <img src="https://preview.keenthemes.com/metronic8/demo1/assets/media/stock/ecommerce/192.png"
                                                class="w-50px ms-n1 me-1" alt="" />
                    ...
                    <div class="card card-flush h-xl-100">
                        <div class="card-header pt-7">
                            ...
                            <div class="card-toolbar">
                                <div class="d-flex flex-stack flex-wrap gap-4">
                                    ...
                                    <a href="https://preview.keenthemes.com/metronic8/demo1/apps/ecommerce/catalog/products.html"
                        ...
                        <div class="card-body">
                            <table class="table align-middle table-row-dashed fs-6 gy-3"
                                ...
                                <thead>
                                    <tr class="text-start text-gray-500 fw-bold fs-7 text-uppercase gs-0">
                                        <th class="min-w-150px ps-3">Item</th>
                                        ...
                                        <th class="text-end pe-0 min-w-75px pe-3">Qty</th>
                                    </tr>
                                </thead>
