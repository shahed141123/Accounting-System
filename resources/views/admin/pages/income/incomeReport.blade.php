                                        ...
                                        <div class="card">
                                            <div class="card-header">
                                                ...
                                                <div class="row my-5">
                                                    ...
                                                    <div class="col-lg-4">
                                                        <p class="mb-0 fw-semibold light-text-color text-center">
                                                            Company
                                                            Info</p>
                                                    ...
                                                    <div class="col-lg-4">
                                                        <p class="mb-0 fw-semibold light-text-color text-end">Billed
                                                            From
                                                        </p>
                                                            ...
                                                            <table class="table mb-0 light-bg-color mb-4"
                                                                ...
                                                                <tbody>
                                                                    <tr>
                                                                        ...
                                                                        <td class="p-3 invoice_bg border-0">
                                                                            <small
                                                                                class="light-text-color">$190</small>
                                                                        </td>
                                                                ...
                                                                <tbody>
                                                                    ...
                                                                    <tr>
                                                                        <td class="invoice_bg border-0"
                                                                            colspan="3">
                                                                            <small class="light-text-color">
                                                                                Please pay the invoice bill by
                                                                                MM/DD/YYYY
                                                                            </small>
                                                                        </td>
                                                                        <td class="invoice_bg border-0">
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        <td class="invoice_bg border-0 text-end"> 0%
                                                                        </td>
                                                                    </tr>
                                                                    <tr>
                                                                        <td class="invoice_bg border-0"
