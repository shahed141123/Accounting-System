            ...
            <form class="form" action="{{ route('admin.experiences.store') }}" method="POST"
                ...
                <div class="row">
                    ...
                    <div class="col-lg-4 mb-7">
                        ...
                        <x-admin.input id="quote" type="text" name="quote" :value="old('quote')"
                    ...
                    <div class="col-lg-4 mb-7">
                        ...
                        <x-admin.input id="starting_year" type="number" name="starting_year" :value="old('starting_year')"
                    ...
                    <div class="col-lg-4 mb-7">
                        ...
                        <x-admin.input id="end_year" type="number" name="end_year" :value="old('end_year')"
                    ...
                    <div class="col-lg-4 mb-7">
                        ...
                        <x-admin.input id="role" type="text" name="role" :value="old('role')"
                    ...
                    <div class="col-lg-4 mb-7">
                        ...
                        <x-admin.input id="organization" type="text" name="organization" :value="old('organization')"
