<x-admin-app-layout :title="'Deal Banner Create'">
    <div class="card card-flash">
        ...
        <div class="card-body pt-0">
            ...
            <form class="form" action="{{ route('admin.deal-banner.store') }}" method="POST" enctype="multipart/form-data">
                @csrf
                ...
                <div class="row my-10">
                    ...
                    <div class="col-lg-4">
                        <x-metronic.label for="price" class="col-form-label fw-bold fs-6 ">{{ __('Deal Banner Price') }}
                        </x-metronic.label>
                    ...
                    <div class="col-lg-4">
                        <x-metronic.label for="offer_price" class="col-form-label fw-bold fs-6 ">{{ __('Deal Banner Offer Price') }}
                        </x-metronic.label>

                        <x-metronic.input id="offer_price" type="number" name="offer_price" placeholder="Enter the Deal Banner Offer Price"
                            :value="old('offer_price')"></x-metronic.input>
                    </div>
                    <div class="col-lg-3">
