            ...
            <form class="form" action="{{ route('admin.email-settings.store') }}" method="POST">
                ...
                <div class="row">
                    <div class="col-lg-4 mb-7">
                        ...
                        <x-admin.input id="mail_mailer" type="text" name="mail_mailer" :value="old('mail_mailer')"
                ...
                <div class="row">
                    <div class="col-lg-4 mb-7">
                        ...
                        <x-admin.input id="mail_username" type="text" name="mail_username" :value="old('mail_username')"
                    ...
                    <div class="col-lg-4 mb-7">
                        ...
                        <x-admin.password-input id="mail_password" name="mail_password" placeholder="Enter mail password" :value="old('mail_password')" required/>
                    </div>
                ...
                <div class="row">
                    <div class="col-lg-4 mb-7">
                        ...
                        <x-admin.input id="mail_from_address" type="email" name="mail_from_address" :value="old('mail_from_address')"
                            placeholder="Enter the From Address" required></x-admin.input>
                    </div>
                    ...
                    <div class="col-lg-4 mb-7">
                        ...
                        <x-admin.input id="mail_from_name" type="text" name="mail_from_name" :value="old('mail_from_name')"
