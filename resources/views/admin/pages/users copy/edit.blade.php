                ...
                <div class="d-flex flex-column scroll-y me-n7 pe-7">
                    <div class="row">
                        <div class="col-lg-2 mb-7">
                            <x-admin.label for="title" class="fw-bold fs-6">
                        ...
                        <div class="col-lg-5 mb-7">
                            ...
                            <x-admin.input id="first_name" type="text" class="form-control-solid mb-3 mb-lg-0"
                                name="first_name" :value="old('first_name',$user->first_name)" placeholder="Enter First name"></x-admin.input>
                        </div>
                        <div class="col-lg-5 mb-7">
                            ...
                            <x-admin.input id="last_name" type="text" class="form-control-solid mb-3 mb-lg-0"
                                name="last_name" :value="old('last_name',$user->last_name)" placeholder="Enter Last name"></x-admin.input>
                        </div>
                        <div class="col-lg-4 mb-7">
                            ...
                            <x-admin.input id="email" type="email" class="form-control-solid mb-3 mb-lg-0"
                                name="email" :value="old('email',$user->email)" placeholder="example@domain.com"></x-admin.input>
                        </div>
                        <div class="col-lg-4 mb-7">
                            <x-admin.label for="phone"
                                class="fw-bold fs-6 mb-2">{{ __('Phone') }}</x-admin.label>
                            <x-admin.input id="phone" type="phone" class="form-control-solid mb-3 mb-lg-0"
                                name="phone" :value="old('phone',$user->phone)" placeholder="Eg:0145******"></x-admin.input>
                        </div>
                        <div class="col-lg-4 mb-7">
                            ...
                            <x-admin.input id="state" type="state" class="form-control-solid mb-3 mb-lg-0"
                                name="state" :value="old('state',$user->state)" placeholder="Enter State"></x-admin.input>
                        </div>
                        <div class="col-lg-4 mb-7">
                        ...
                        <div class="col-lg-6 mb-7">
                            <x-admin.label for="password"
                                class="fw-bold fs-6 mb-2">{{ __('Password') }}</x-admin.label>
                        ...
                        <div class="col-lg-6 mb-7">
                            <x-admin.label for="password_confirmation"
                                class="fw-bold fs-6 mb-2">{{ __('Confirm Password') }}</x-admin.label>
