                    ...
                    <div class="card border-0 shadow-none">
                        <div class="card-header p-3 bg-custom text-white">
                            <div class="d-flex justify-content-between align-items-center">
                                <div>
                                    <h4 class="mb-0">Employee Departments</h4>
                                </div>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <span
                                                    ...
                                                    {{ $department->status == 'active' ? 'Active' : 'InActive' }}</span>
                                            </td>
                                            <td>
                                                <a href="javascript:void(0)" class="btn btn-sm btn-primary"
                                                    data-bs-toggle="modal"
                                                    data-bs-target="#editCategoryModal{{ $department->id }}">
                                                ...
                                                <a href="{{ route('admin.employeee-department.destroy', $department->id) }}"
                                                    class="btn btn-sm btn-danger delete">
                                                    <i class="fa-solid fa-trash"></i>
                                                </a>
                                                <div class="modal fade" id="editCategoryModal{{ $department->id }}"
                                                        ...
                                                        <div class="modal-content">
                                                            ...
                                                            <div class="modal-body">
                                                                <form method="POST" enctype="multipart/form-data"
                                                                    action="{{ route('admin.employeee-department.update', $department->id) }}">
                                                                    @method('PUT')
                                                                    @csrf
                                                                    <div class="mb-3">
                                                                        <label for="name"
                                                                    ...
                                                                    <div class="mb-3">
                                                                        ...
                                                                        {{-- <textarea class="form-control form-control-solid" id="note" name="note" rows="3">{{ old('note',$department->note) }}</textarea> --}}
                                                                        <x-admin.textarea id="note" name="note"
                                                                            :rows="2">{{ old('note', $department->note) }}</x-admin.textarea>
                                                                    </div>
                                                                    ...
                                                                    <div class="mb-3">
                                                                        ...
                                                                        <x-admin.select-option
                                                                            ...
                                                                            <option value="active"
                                                                                @selected($department->status == 'active')>Active
                                                                            </option>
                                                                            <option value="inactive"
                                                                                @selected($department->status == 'inactive')>Inactive
                                                                            </option>
                                                                        </x-admin.select-option>
                                                                    </div>
    ...
    <div class="modal fade" id="addCategoryModal" tabindex="-1" aria-labelledby="addCategoryModalLabel"
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form method="POST" action="{{ route('admin.employeee-department.store') }}"
