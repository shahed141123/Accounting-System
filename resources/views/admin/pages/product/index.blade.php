<x-admin-app-layout :title="'Product List'">
    <div class="card card-flash">
        ...
        <div class="card-body pt-0">
            ...
            <table class="productDT table align-middle table-row-dashed fs-6 gy-5 mb-0" id="kt_permissions_table">
        ...
        <script>
            $(document).ready(function() {
                ...
                $(document).on('change', '.status-toggle', function() {
                    ...
                    const route = "{{ route('admin.product.toggle-status', ':id') }}".replace(':id', id);
