                ...
                <div class="modal-body">
                    <form id="kt_docs_formvalidation_text" class="form" action="{{ route('admin.blog-tags.store') }}"
                        ...
                        <div class="fv-row mb-5">
                            <x-admin.label class="required fw-semibold fs-6 mb-2">Blog Tag
                                Title</x-admin.label>
                            <x-admin.input type="text" name="name" class="form-control mb-3 mb-lg-0"
                                placeholder="Set Blog tag Title" :value="old('name')" />
                        </div>
                        <div class="fv-row mb-5">
                            <x-admin.label class="fw-semibold fs-6 mb-2">Blog Meta Title</x-admin.label>
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form id="kt_docs_formvalidation_text" class="form"
                            ...
                            @method('PUT')
                            <div class="fv-row mb-5">
                                <x-admin.label class="required fw-semibold fs-6 mb-2">Title</x-admin.label>
                                <x-admin.input type="text" name="name" class="form-control mb-3 mb-lg-0"
