            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="card mt-5">
                        ...
                        <div class="card-body">
                            <form method="POST" action="{{ route('admin.assets-type.update',$asset_type->id) }}"
                                ...
                                <div class="row">
                                    <div class="col-lg-6 col-md-6">
                                        <div class="mb-3">
                                            ...
                                            <x-admin.input type="text" :value="old('name',$asset_type->name)" id="name"
                                    ...
                                    <div class="col-lg-4 col-md-6">
                                        <div class="mb-3">
                                            ...
                                            <x-admin.select-option id="status" name="status" :allowClear="true">
                                                <option value="active"
                                                    {{ old('status',$asset_type->status) == 'active' ? 'selected' : '' }}>Active</option>
                                                <option value="inactive"
                                                    {{ old('status',$asset_type->status) == 'inactive' ? 'selected' : '' }}>Inactive
                                                </option>
                                    ...
                                    <div class="col-lg-12">
                                        <div class="mb-3">
                                            ...
                                            <textarea class="form-control text-area-input" id="note" name="note" rows="3"
                                                placeholder="Write your note here">{{ old('note',$asset_type->note) }}</textarea>
                                            @error('note')
                                ...
                                <x-admin.button type="submit" class="">Update Assets Type<i
