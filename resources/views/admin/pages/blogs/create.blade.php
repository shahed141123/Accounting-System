    ...
    <div class="card card-flash">
        ...
        <div class="card-body pt-0">
            <form class="form" action="{{ route('admin.blogs.store') }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="row">
                    <div class="col-lg-4">
                        <x-admin.label for="admin_id"
                            class="col-form-label fw-bold fs-6">{{ __('Select a author name') }}</x-admin.label>
                        <x-admin.select-option id="admin_id" name="admin_id" data-hide-search="false"
                    ...
                    <div class="col-lg-4">
                        <x-admin.label for="category_id"
                            class="col-form-label fw-bold fs-6">{{ __('Select a category name') }}</x-admin.label>
                        <x-admin.select-option id="category_id" name="category_id" data-hide-search="false"
                            data-placeholder="Select an option">
                            <option></option>
                    ...
                    <div class="col-lg-4">
                        <x-admin.label for="tag_id"
                            class="col-form-label fw-bold fs-6">{{ __('Select a tag name') }}</x-admin.label>
                        <x-admin.select-option id="tag_id" name="tag_id" data-hide-search="false"
                            data-placeholder="Select an option">
                            <option></option>
                            @foreach ($tags as $tag)
                    ...
                    <div class="col-lg-4 mb-7">
                        ...
                        <x-admin.input id="title" type="text" name="title" :value="old('title')"
                    ...
                    <div class="col-lg-4 mb-7">
                        ...
                        <x-admin.input id="url" type="url" name="url" :value="old('url')"
                            placeholder="Enter the Url"></x-admin.input>
                    </div>

                    <div class="col-lg-4 mb-7">
                        <x-admin.label for="badge"
                            class="col-form-label fw-bold fs-6 required">{{ __('Badge') }}
                        </x-admin.label>

                        <x-admin.input id="badge" type="text" name="badge" :value="old('badge')"
                            placeholder="Enter the Badge"></x-admin.input>
                    </div>

                    <div class="col-lg-4 mb-7">
                        <x-admin.label for="summary"
                            class="col-form-label fw-bold fs-6 required">{{ __('Summary') }}
                        </x-admin.label>

                        <x-admin.input id="summary" type="text" name="summary" :value="old('summary')"
                            placeholder="Enter the Summary"></x-admin.input>
                    </div>

                    <div class="col-lg-4 mb-7">
                        <x-admin.label for="published_at"
                            class="col-form-label fw-bold fs-6 required">{{ __('Published At') }}
                        </x-admin.label>

                        <x-admin.input id="published_at" type="text" name="published_at" :value="old('published_at')"
                            placeholder="Enter the Published At"></x-admin.input>
                    </div>
                    ...
                    <div class="col-lg-4 mb-7">
                        ...
                        <x-admin.input id="logo" type="file" name="logo"></x-admin.input>
                    </div>

                    <div class="col-lg-4 mb-7">
                        <x-admin.label for="default-editor"
                            class="col-form-label fw-bold fs-6 ">{{ __('Description') }}
                        </x-admin.label>

                        <x-admin.textarea id="default-editor" name="description"></x-admin.textarea>
                    </div>
                </div>
