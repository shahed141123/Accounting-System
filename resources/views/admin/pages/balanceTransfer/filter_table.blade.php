@foreach ($transfers as $transfer)
    <tr>
        ...
        <td class="text-end">
            <a href="{{ route('admin.balance-transfer.edit', $transfer->slug) }}" class="btn btn-sm btn-primary toltip" data-tooltip="Edit">
                <i class="fa-solid fa-pen"></i>
            </a>
            <a href="{{ route('admin.balance-transfer.destroy', $transfer->id) }}" class="btn btn-sm btn-danger toltip" data-tooltip="Delete">
