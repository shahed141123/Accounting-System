                ...
                <div class="card mt-5">
                    <div class="card-header p-2">
                        <div class="d-flex align-items-center justify-content-between">
                            <h4 class="text-gray-800">Create Terms & Condition</h4>
                            <a href="{{ route('admin.terms-condition.index') }}" class="btn-common-one text-white"
                                tabindex="0">
                    ...
                    <div class="card-body">
                        <div>
                            <form class="form" action="{{ route('admin.terms-condition.store') }}" method="POST"
                                ...
                                <div class="mt-4">
                                    <x-admin.button type="submit">Save Terms<i
