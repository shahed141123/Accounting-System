                    ...
                    <div class="card border-0 shadow-none">
                        <div class="card-header p-3 bg-custom text-white">
                            <div class="d-flex justify-content-between align-items-center">
                                <div>
                                    <h4 class="mb-0">Create Or Delete Terms & Policy</h4>
                                </div>
                                <div class="btn-group" role="group" aria-label="Basic outlined example">
                                    ...
                                    <a href="{{ route('admin.terms-condition.create') }}"
                                ...
                                <tbody>
                                    @foreach ($terms as $key => $term)
                                        <tr class="fw-bold text-gray-400 text-center">
                                            ...
                                            <td>{{ $term->title }}</td>
                                            <td>{{ $term->version }}</td>
                                            <td>{{ Carbon\Carbon::parse($term->effective_date)->format('D,d M Y') }}
                                            </td>
                                            <td>{{ Carbon\Carbon::parse($term->expiration_date)->format('D,d M Y') }}
                                            </td>
                                            <td>
                                            ...
                                            <td>
                                                ...
                                                <a href="{{ route('admin.terms-condition.destroy', $term->id) }}"
                                                    class="btn btn-sm btn-danger toltip delete" data-tooltip="Delete"
