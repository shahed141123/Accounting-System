<x-frontend-app-layout :title="'Contact Us'">
    ...
    <div class="container my-5">
        ...
        <p>Welcome to piqpaq! These terms and conditions outline the rules and regulations for the use of
            piqpaq's Website, located at <a href="https://piqpaq.com/">https://piqpaq.com/</a>.</p>
        ...
        <p>By accessing this website, we assume you accept these terms and conditions in full. Do not continue to use
            piqpaq's website if you do not accept all of the terms and conditions stated on this page.</p>

        <h2 class="mt-5">2. License</h2>
        <p>Unless otherwise stated, piqpaq and/or its licensors own the intellectual property rights for all
            material on piqpaq. All intellectual property rights are reserved. You may view and/or print pages from
            https://piqpaq.com/ for your own personal use subject to restrictions set in these terms and conditions.
        </p>
        <p>You must not:</p>
        <ul>
            <li>Republish material from https://piqpaq.com/</li>
            <li>Sell, rent, or sub-license material from https://piqpaq.com/</li>
            <li>Reproduce, duplicate, or copy material from https://piqpaq.com/</li>
            <li>Redistribute content from piqpaq (unless content is specifically made for redistribution).</li>
        </ul>

        <h2 class="mt-5">3. User Comments</h2>
        <p>This Agreement shall begin on the date hereof.</p>
        <p>Certain parts of this website offer the opportunity for users to post and exchange opinions, information,
            material, and data ('Comments') in areas of the website. piqpaq does not screen, edit, publish, or
            review Comments prior to their appearance on the website, and Comments do not reflect the views or opinions
            of piqpaq, its agents, or affiliates. Comments reflect the view and opinion of the person who posts such
            views or opinions.</p>
        <p>To the extent permitted by applicable laws, piqpaq shall not be responsible or liable for the Comments or
            for any loss, cost, liability, damages, or expenses caused and/or suffered as a result of any use of and/or
            posting of and/or appearance of the Comments on this website.</p>
        <p>piqpaq reserves the right to monitor all Comments and to remove any Comments that it considers in its
            absolute discretion to be inappropriate, offensive, or otherwise in breach of these Terms and Conditions.
        </p>

        <h2 class="mt-5">4. Hyperlinking to Our Content</h2>
        ...
        <ul>
            ...
            <li>Online directory distributors when they list us in the directory may link to our Website in the same
                manner as they hyperlink to the Websites of other listed businesses;</li>
        ...
        <h2 class="mt-5">5. Content Liability</h2>
        ...
        <h2 class="mt-5">6. Reservation of Rights</h2>
