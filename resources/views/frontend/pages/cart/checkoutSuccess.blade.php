        ...
        <div class="container">
            <div class="card">
                <div class="card-header text-center">
                    <h5 class="card-title">Your Order has successfully been submitted</h5>
                </div>
            </div>
                    ...
                    <div class="mx-auto w-100">
                        <div class="d-flex justify-content-between flex-column flex-sm-row mb-19">
                            ...
                            <div class="text-sm-end">
                                <a href="#" class="d-block mw-150px ms-sm-auto">
                                    <img alt="Logo" src="https://piqpaq.flixzaglobal.com/frontend/img/logo.png"
                                        class="w-100">
                                </a>
                        ...
                        <div class="d-flex flex-column gap-7 gap-md-10">
                            <div class="fw-bold fs-2">
                                Dear {{ $order->user->first_name }} <span class="fs-6">({{ $order->user->email }}
                                    )</span>,<br>
                        ...
                        <div class="d-flex flex-stack flex-wrap mt-lg-10 pt-05">
                            <div class="my-1 me-5">
                                <button type="button printButton" class="btn btn-success my-1 me-5"
    ...
    @push('scripts')
        <script>
            document.addEventListener('DOMContentLoaded', function() {
                // Select all buttons with the print functionality
                document.querySelectorAll('button[data-order-id]').forEach(function(button) {
